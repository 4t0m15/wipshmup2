extends Node
class_name StageController_Refactored

# StageController_Refactored - Data-driven stage controller
...
func _ready() -> void:
	...
	print("[StageController_Refactored] Initialized")

func start_run() -> void:
	"""Start the stage progression"""
	print("[StageController_Refactored] Starting stage run")
...
func _start_current_stage() -> void:
	...
	print("[StageController_Refactored] Starting stage: ", current_stage.stage_name)
...
func _start_current_wave() -> void:
	...
	print("[StageController_Refactored] Starting wave: ", current_wave.wave_name)
...
func _start_boss_encounter() -> void:
	...
	print("[StageController_Refactored] Starting boss: ", boss_encounter.boss_name)
...
func _on_boss_defeated() -> void:
	"""Handle boss defeat"""
	print("[StageController_Refactored] Boss defeated")
...
func _complete_stage() -> void:
	...
	print("[StageController_Refactored] Stage completed: ", current_stage.stage_name)
...
func _process(delta: float) -> void:
	...
	if current_wave and current_spawn_index >= current_wave.get_spawn_count():
		...
		if current_wave.wave_duration > 0.0 and wave_timer >= current_wave.wave_duration:
...
func _complete_current_wave() -> void:
	...
	print("[StageController_Refactored] Wave completed: ", current_wave.wave_name)
