...
@export var move_speed_phase1: float = 30.0  # Reduced from 70.0 for playable speed
@export var move_speed_phase2: float = 50.0  # Reduced from 120.0 for playable speed
